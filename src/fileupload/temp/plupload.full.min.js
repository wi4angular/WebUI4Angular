 ...
 * Date: 2014-05-14
 */
// 在 _window 中创建了 moxie 对象，并依层级保存，叶子为 s["moxie/core/utils/Basic"]等
!function (_window, _undef) {
    "use strict";
    // 遍历 strAry，若其中元素 val 存在 s.val 或 getObj(val)，存入 args，并运行 fun(args) 函数
    function doFun(strAry, fun) {
        for (var n, args = [], i = 0; i < strAry.length; ++i) {
            if (n = s[strAry[i]] || getObj(strAry[i]), !n) throw"相关模块未定义: " + strAry[i];
            args.push(n)
        }
        fun.apply(null, args)
    }
    // s[module] = definition( 参数为 dependencies 中 存在于 s 中或 window 对象中的 )
    function i(module, dependencies, definition) {
        if ("string" != typeof module)throw"无效的模块定义，模块 id 必须定义且为 string";
        if (dependencies === _undef)throw"无效的模块定义，必须指定依赖";
        if (definition === _undef)throw"无效的模块定义，必须指定依赖函数";
        doFun(dependencies, function () {
            s[module] = definition.apply(null, arguments)
        })
    }
    // 判断 s 中是否存在 dir
    function hasdir(dir) {
    ...
    // 从 _window 中找到 t 对应的对象并返回
    function getObj(t) {
        for (var n = _window, i = t.split(/[.\/]/), j = 0; j < i.length; ++j) {
            if (!n[i[j]]) return;
            n = n[i[j]]
        }
        return n
    }
    // 根据 dirs[] 中每项的层级在 window 对象下创建，最后一级值为 s[str]
    function initDirs(dirs) {
        for (var i = 0; i < dirs.length; i++) {
            for (var dir = _window, str = dirs[i], a = str.split(/[.\/]/), u = 0; u < a.length - 1; ++u)
                dir[a[u]] === _undef && (dir[a[u]] = {}), dir = dir[a[u]];
            dir[a[a.length - 1]] = s[str]
        }
    }
    ...
    i(u, [],
        function () {
            var _typeOf = function (e) {
                ...
                ,t = function (i) {
                    ...
                    return n(arguments, function (o, s) {
                        s > 0 && n(o, function (n, o) {
                            n !== r && (_typeOf(i[o]) === _typeOf(n) && ~a(_typeOf(n), ["array", "object"]) ? t(i[o], n) : i[o] = n)
                        })
                    }), i
                }
                ,n = function (e, t) {
                ...
                ,i = function (t) {
                    var n;
                    if (!t || "object" !== _typeOf(t))return!0;
                    for (n in t)return!1;
                    return!0
                }
                ,r = function (t, n) {
                    function i(r) {
                        "function" === _typeOf(t[r]) && t[r](function (e) {
                            ++r < o && !e ? i(r) : n(e)
                        })
                    }

                    var r = 0, o = t.length;
                    "function" !== _typeOf(n) && (n = function () {
                    }), t && t.length || n(), i(r)
                }
                ,o = function (e, t) {
                ...
                ,s = function (t, n) {
                    var i = [];
                    "array" !== _typeOf(t) && (t = [t]), "array" !== _typeOf(n) && (n = [n]);
        ...
        function (e) {
            ...
            var n = function (e) {
                var t = "", n = "?", i = "function", r = "undefined", o = "object", a = "major", s = "model", u = "name", c = "type", l = "vendor", d = "version", f = "architecture", h = "console", p = "mobile", m = "tablet", g = {has: function (e, t) {
        ...
        function (e, t, n) {
            return function i() {
                var i;
                t.extend(this, {
                    connectRuntime: function (r) {// connectRuntime;
                    function o(t) {
                        var s, u;
...
//                        }), i.mode ? void i.init() : void i.trigger("Error")) : void o(t)) : (a.trigger("RuntimeError", new e.RuntimeError(e.RuntimeError.NOT_INIT_ERR)), void(i = null))
                            ...
                            (
                                ...
                                (u = n.getConstructor(s)) ?
                                    (
                                        ...
                                        /*i.bind("Error", function () { del test
                                            i.destroy(), o(t)
                                        }),*/
                                        i.mode ?
                                            void i.init() :// init
                                            void i.trigger("Error")
                                    ) :
                                    void o(t)
                            ) :
                            (
                                a.trigger("RuntimeError", new e.RuntimeError(e.RuntimeError.NOT_INIT_ERR)),
                                void(i = null)
                            )
                    }
        ...
        function (e, t, n) {
            function i(o, a) {
                ...
                n.call(this), o && this.connectRuntime(o), a ? "string" === e.typeOf(a) && (a = {data: a}) : a = {}, e.extend(this, {
                    ...
                    , getSource: function () {
                        return hasdir[this.uid] ? hasdir[this.uid] : null
                    }
                    , detach: function (e) {
                        this.ruid && (this.getRuntime().exec.call(this, "Blob", "destroy"), this.disconnectRuntime(), this.ruid = null), e = e || "";
                        var n = e.match(/^data:([^;]*);base64,/);
                        n && (this.type = n[1], e = t.atob(e.substring(e.indexOf("base64,") + 7))), this.size = e.length, hasdir[this.uid] = e
                    }
                    , isDetached: function () {
                        return!this.ruid && "string" === e.typeOf(hasdir[this.uid])
                    }
                    , destroy: function () {
                        this.detach(), delete hasdir[this.uid]
                    }}), a.data ? this.detach(a.data) : hasdir[this.uid] = a
            }
                    ...
                    init: function () {
                        ...
                        c.bind("RuntimeInit", function (t, i) {
                            ...
                            c.bind("Refresh", function () {
                                var pos, size, node, div;
                                node = n.get(r.browse_button),// 触发原始节点
                                div = n.get(i.shimid),// 生成的含 file-input 的 div 节点
                                node && (pos = n.getPos(node, n.get(r.container)),// 位置坐标
                                size = n.getSize(node),// 尺寸
                                div && e.extend(div.style, {top: pos.y + "px", left: pos.x + "px", width: size.w + "px", height: size.h + "px"})),
                                div = node = null
                            }),
        ...
        function (e, t, n, i, r, o, a, s, u, c, l, d) {
            ...
            function _xmlHttpRequest() {
                ...
                function u(t) {// t: formdata('file',file)
                    function i() {
                        k && (k.destroy(), k = null), xhr.dispatchEvent("loadend"), xhr = null
                    }

                    function r(r) {
                        /*k.bind("LoadStart", function (e) { del test
                            n("readyState", _xmlHttpRequest.LOADING), xhr.dispatchEvent("readystatechange"), xhr.dispatchEvent(e), I && xhr.upload.dispatchEvent(e)
                        }),
                        k.bind("Progress", function (e) {
                            n("readyState") !== _xmlHttpRequest.LOADING && (n("readyState", _xmlHttpRequest.LOADING), xhr.dispatchEvent("readystatechange")), xhr.dispatchEvent(e)
                        }),
                        k.bind("UploadProgress", function (e) {
                            I && xhr.upload.dispatchEvent({type: "progress", lengthComputable: !1, total: e.total, loaded: e.loaded})
                        }),
                        k.bind("Load", function (t) {
//                            n("readyState", _xmlHttpRequest.DONE), n("status", Number(r.exec.call(k, "XMLHttpRequest", "getStatus") || 0)), n("statusText", p[n("status")] || ""), n("response", r.exec.call(k, "XMLHttpRequest", "getResponse", n("responseType"))), ~e.inArray(n("responseType"), ["text", ""]) ? n("responseText", n("response")) : "document" === n("responseType") && n("responseXML", n("response")), U = r.exec.call(k, "XMLHttpRequest", "getAllResponseHeaders"), xhr.dispatchEvent("readystatechange"), n("status") > 0 ? (I && xhr.upload.dispatchEvent(t), xhr.dispatchEvent(t)) : (N = !0, xhr.dispatchEvent("error")), i()
                            n("readyState", _xmlHttpRequest.DONE);
                            ...
                            n("status") > 0 ?
                                (I && xhr.upload.dispatchEvent(t), xhr.dispatchEvent(t)) :
                                (N = !0, xhr.dispatchEvent("error")), i();
                        }),
                        k.bind("Abort", function (e) {
                            xhr.dispatchEvent(e), i()
                        }),
                        k.bind("Error", function (e) {
                            N = !0, n("readyState", _xmlHttpRequest.DONE), xhr.dispatchEvent("readystatechange"), D = !0, xhr.dispatchEvent(e), i()
                        }),*/
                        r.exec.call(k, "XMLHttpRequest", "send", {// ----- 0
                            url: E,
                            method: _,
                            /*async: w, del test
                            user: b,
                    ...
                    M = (new Date).getTime(),
                    k = new a,
                    /*"string" == typeof P.required_caps && (P.required_caps = o.parseCaps(P.required_caps)), del test
                    P.required_caps = e.extend({}, P.required_caps, {return_response_type: xhr.responseType}),
                    ...
                    P.ruid ?
                        ...
                        (*/
                            ...
                            /*k.bind("RuntimeError", function (e, t) { del test
                                xhr.dispatchEvent("RuntimeError", t)
                            }),*/
                            k.connectRuntime(P)
                        /*)*/
                }
                ...
                var v = this,
                    y = {
                        timeout: 0
                        ,readyState: _xmlHttpRequest.UNSENT
                        ,withCredentials: !1
                        ,status: 0
                        ,statusText: ""
                        ,responseType: ""
                    ...
                    ,B,C,E,M,R,_,b,k
                    ,x = {},P = {}
                    ,A = null,F = null,H = null,T = null
                    ,S = !1,O = !1,I = !1,D = !1,N = !1,L = !1
                    ,U = "";
                e.extend(this, y, {
                    uid: e.guid("uid_")
                    ,upload: new f
                    ,open: function (o, a, s, u, c) {
                        ...
                        S = !w, O = !1, x = {}, g.call(this), n("readyState", _xmlHttpRequest.OPENED), this.convertEventPropsToHandlers(["readystatechange"]), this.dispatchEvent("readystatechange")
                    }
                    ,setRequestHeader: function (r, o) {
                        ...
                        if (n("readyState") !== _xmlHttpRequest.OPENED || O)throw new t.DOMException(t.DOMException.INVALID_STATE_ERR);
                    ...
                    ,getResponseHeader: function (t) {
                        return t = t.toLowerCase()
                            ,N || ~e.inArray(t, ["set-cookie", "set-cookie2"]) ? null : U && "" !== U && (B || (B = {}, e.each(U.split(/\r\n/), function (t) {
                            var n = t.split(/:\s+/);
                    ...
                    ,overrideMimeType: function (i) {
                        var r, o;
                        if (~e.inArray(n("readyState"), [_xmlHttpRequest.LOADING, _xmlHttpRequest.DONE]))throw new t.DOMException(t.DOMException.INVALID_STATE_ERR);
                    ...
                    ,send: function (n, r) {// formdata('file',file), {...}
                        if (
                                P = "string" === e.typeOf(r) ?
                                    {ruid: r} :
                                    r ?
                                        r :
                                        {},// P = r
                                /*this.convertEventPropsToHandlers(m), del test
                                this.upload.convertEventPropsToHandlers(m),*/
                                this.readyState !== _xmlHttpRequest.OPENED || O
                            )
...
/*                            if (n.hasBlob()) { del test
                                var o = n.getBlob();
                                P.ruid = o.ruid,
                                A = o.type || "application/octet-stream"// text/plain
                            }*/
                        } else
                            "string" == typeof n && (
                                T = "UTF-8",
...
/*                        this.withCredentials || (this.withCredentials = P.required_caps && P.required_caps.send_browser_cookies && !L), del test
                    ...
                    ,abort: function () {
                        if (N = !0, S = !1, ~e.inArray(n("readyState"), [_xmlHttpRequest.UNSENT, _xmlHttpRequest.OPENED, _xmlHttpRequest.DONE]))n("readyState", _xmlHttpRequest.UNSENT); else {
                            if (n("readyState", _xmlHttpRequest.DONE), O = !1, !k)throw new t.DOMException(t.DOMException.INVALID_STATE_ERR);
            ...
            return _xmlHttpRequest.UNSENT = 0, _xmlHttpRequest.OPENED = 1, _xmlHttpRequest.HEADERS_RECEIVED = 2, _xmlHttpRequest.LOADING = 3, _xmlHttpRequest.DONE = 4, _xmlHttpRequest.prototype = n.instance, _xmlHttpRequest
        }
    ), i(O, [u, m, v, p],
        function (e, t, n, i) {
            function r() {
        ...
        function (e, t, n, i, r, o) {
            function a() {
                ...
                t.extend(this, {init: function (s) {
                    var u = this, c = u.getRuntime(), input_file, d, f, h, p, m;
                    a = s, e = [], f = a.accept.mimes || r.extList2mimes(a.accept, c.can("filter_by_extension")),
                    d = c.getShimContainer(),
                    d.innerHTML = '<input id="' + c.uid + '" type="file" style="font-size:999px;opacity:0;"' + (
                        ...
                        f ?
                            ' accept="' + f.join(",") + '"' :
                            "") + " />",
                    input_file = n.get(c.uid),// input-file 节点
                    t.extend( input_file.style, {position: "absolute", top: 0, left: 0, width: "100%", height: "100%"}),
                    h = n.get(a.browse_button),
                    c.can("summon_file_dialog") && (
                        "static" === n.getStyle(h, "position") && (h.style.position = "relative"),
                    ...
                    input_file.onchange = function g() {
                        console.log('change==');
                ...
                t.extend(this, {
                    send: function (n, r) {
                        ...
                        h.upload ?
                            ...
                            "" !== n.responseType && "responseType"in h && (h.responseType = "json" !== n.responseType || u.can("return_response_type", "json") ?
                                n.responseType :
                                "text");
                            m ?
                                h.sendAsBinary ?
        ...
        function (e, n) {
            return function i() {
                function i(e, n) {
                    ...
                    for (r = 0; i > r; r++)if (h = f = e + 12 * r + 2, s = n[a.SHORT(h)], s !== _undef) {
        ...
        function (e, t, n, i, r) {
            function o(o) {
                ...
                l = new n(o), d = new r, h = !!d.init(l.get("app1")[0]), f = a.call(this), e.extend(this, {type: "image/jpeg", size: u.length, width: f && f.width || 0, height: f && f.height || 0, setExif: function (t, n) {
            ...
            function a(a) {
                ...
                a = e.extend({swf_url: t.swf_url}, a), r.call(this, a, s, {access_binary: function (e) {
                    ...
                    o = this.getShimContainer()
                        ...
                        , n += 'width="100%" height="100%" style="outline:0">' +
                        '<param name="movie" value="' + a.swf_url + '" />' +
    ...
    ), initDirs([u, c, l, d, f, h, p, m, g, v, y, w, E, _, x, b, R, T, A, S, O, I, L])
}(this);
...
(function (_window, _undef) {
    var _moxieMethods = {
        Env: _window.moxie.core.utils.Env
        ,Mime: _window.moxie.core.utils.Mime
        ,Exceptions: _window.moxie.core.Exceptions
    };
    function initMoxie(obj) {// 递归将 moxie 中所有层级的方法存入 methods 对象
        var prop, type;
        for (prop in obj){
            type = typeof obj[prop];
            type === "object" && ["Exceptions", "Env", "Mime"].indexOf(prop) < 0 ?
                initMoxie(obj[prop]) :// 是 object 且 非 ["Exceptions", "Env", "Mime"]，递归
                type === "function" && (_moxieMethods[prop] = obj[prop]);
        }
    }
    initMoxie(_window.moxie);
    _moxieMethods.Env = _window.moxie.core.utils.Env;
    _moxieMethods.Mime = _window.moxie.core.utils.Mime;
    _moxieMethods.Exceptions = _window.moxie.core.Exceptions;
    // -------------------------------------------------------
    var _typeOf = function (e) {
        var t;
        return e === t ? "undefined" : null === e ? "null" : e.nodeType ? "node" : {}.toString.call(e).match(/\s([a-z|A-Z]+)/)[1].toLowerCase()
    ...
    function s(e) {// o.Uploader.N() 方法调用
        function r(e, t, r) {
            var i = {
                chunks: "slice_blob"
...
//            ,mimeTypes: _moxieMethods.mimes
//            ,ua: _moxieMethods.ua
//            ,typeOf: _moxieMethods.typeOf
            /*,*/STOPPED: 1
            ,STARTED: 2
            ,QUEUED: 1
            ,UPLOADING: 2
            ...
            ,extend: _moxieMethods.extend
            ,guid: _moxieMethods.guid
            ,get: function (n) {
                var r = [] ,i;
                _typeOf(n) !== "array" && (n = [n]);
                var s = n.length;
                while (s--)i = _moxieMethods.get(n[s])
                    ,i && r.push(i);
                return r.length ? r : null
            }
            ,each: _moxieMethods.each
//            ,getPos: _moxieMethods.getPos
//            ,getSize: _moxieMethods.getSize
...
//                }) : e
//            }
//            ,toArray: _moxieMethods.toArray
            ,inArray: _moxieMethods.inArray
//            ,addI18n: _moxieMethods.addI18n
//            ,translate: _moxieMethods.translate
//            ,isEmptyObj: _moxieMethods.isEmptyObj
//            ,hasClass: _moxieMethods.hasClass
//            ,addClass: _moxieMethods.addClass
//            ,removeClass: _moxieMethods.removeClass
//            ,getStyle: _moxieMethods.getStyle
//            ,addEvent: _moxieMethods.addEvent
//            ,removeEvent: _moxieMethods.removeEvent
//            ,removeAllEvents: _moxieMethods.removeAllEvents
...
//                }
//
//                if (e === _undef || /\D/.test(e))return "N/A";
//                var r = Math.pow(1024, 4);
//                return e > r ? t(e / r, 1) + " tb" : e > (r /= 1024) ? t(e / r, 1) + " gb" : e > (r /= 1024) ? t(e / r, 1) + " mb" : e > 1024 ? Math.round(e / 1024) + " kb" : e + " b"
//            }
//            ,parseSize: _moxieMethods.parseSizeStr
//            ,predictRuntime: function (e, n) {
//                var r, i;
//                return r = new o.Uploader(e), i = _moxieMethods.Runtime.thatCan(r.getOption().required_features, n || e.runtimes), r.destroy(), i
//            }
//            ,addFileFilter: function (e, t) {
//                i[e] = t
//            }
        };
    i["mime_types"] = function (e, t, n) {
        e.length && !e.regexp.test(t.name) ?
            (this.trigger("Error", {code: o.FILE_EXTENSION_ERROR, message: "File extension error.", file: t}), n(!1)) :
            n(!0)
    };
    i["max_file_size"] = function (e, t, n) {
        var r;
        /*e = o.parseSize(e), */t.size !== r && e && t.size > e ? (this.trigger("Error", {code: o.FILE_SIZE_ERROR, message: "File size error.", file: t}), n(!1)) : n(!0)
    };
    i["prevent_duplicates"] = function (e, t, n) {
        if (e) {
            var r = this.files.length;
            while (r--)if (t.name === this.files[r].name && t.size === this.files[r].size) {
                this.trigger("Error", {code: o.FILE_DUPLICATE_ERROR, message: "Duplicate file error.", file: t}), n(!1);
                return
            }
        }
        n(!0)
    };
    o.Uploader = function (options) {// options: 用户自定义配置
        function g() {
            var e, t = 0, n;
...
//            var e, t;
//            d.reset();
//            for (e = 0; e < f.length; e++)t = f[e], t.size !== _undef ? (d.size += t.origSize, d.loaded += t.loaded * t.origSize / t.size) : d.size = _undef, t.status == o.DONE ? d.uploaded++ : t.status == o.FAILED ? d.failed++ : d.queued++;
//            d.size === _undef ? d.percent = f.length > 0 ? Math.ceil(d.uploaded / f.length * 100) : 0 : (d.bytesPerSec = Math.ceil(d.loaded / ((+(new Date) - p || 1) / 1e3)), d.percent = d.size > 0 ? Math.ceil(d.loaded / d.size * 100) : 0)
        }
        ...
        function E(e, n) {
            if (e.ruid) {
                var r = _moxieMethods.Runtime.getInfo(e.ruid);
                if (r)return r.can(n)
            }
            return!1
        }
        ...
        function x(e, n) {// N() 方法中调用
            ...
            o.each(e.runtimes.split(/\s*,\s*/), function (t) {
                ...
                s.push(function (s) {
                    var a = new _moxieMethods.FileInput(o.extend({}, u, {accept: e.filters.mime_types, name: e.file_data_name, multiple: e.multi_selection, container: e.container, browse_button: n}));
                    a.onready = function () {
                        var e = _moxieMethods.Runtime.getInfo(this.ruid);
                        _moxieMethods.extend(r.features, {chunks: e.can("slice_blob"), multipart: e.can("send_multipart"), multi_selection: e.can("select_multiple")}), i++, c.push(this), s()
                    }, a.onchange = function () {
                        r.addFile(this.files)
                    }/*, a.bind("mouseenter mouseleave mousedown mouseup", function (r) {
                     v || (e.browse_button_hover && ("mouseenter" === r.type ? _moxieMethods.addClass(n, e.browse_button_hover) : "mouseleave" === r.type && _moxieMethods.removeClass(n, e.browse_button_hover)), e.browse_button_active && ("mousedown" === r.type ? _moxieMethods.addClass(n, e.browse_button_active) : "mouseup" === r.type && _moxieMethods.removeClass(n, e.browse_button_active)))
                ...
                s.push(function (n) {
                    var s = new _moxieMethods.FileDrop(o.extend({}, u, {drop_zone: e}));
                    s.onready = function () {
                        var e = _moxieMethods.Runtime.getInfo(this.ruid);
            ...
            }), _moxieMethods.inSeries(s, function () {
                typeof n == "function" && n(i)
            })
        }

        function T(e, r, i) {
            var s = new _moxieMethods.Image;
            try {
                s.onload = function () {
                    if (r.width > this.width && r.height > this.height && r.quality === _undef && r.preserve_headers && !r.crop)return this.destroy(), i(e);
        ...
        // modifyConf
        function N(_options, n, extend) {// 扩展 conf(_options 为对象-对象扩展；_options 非对象-conf[_options] = n)
            function f(prop, val, extend) {// extend: true(保留 conf[prop] 中 options[prop] 未修改的配置)
                var r = conf[prop];
                switch (prop) {// 根据用户自定义配置(_options)修改 conf
                    case"filters":
                        /*o.typeOf(val) === "array" && (val = {mime_types: val}), */
                        extend ? o.extend(conf.filters, val) : conf.filters = val;
                        val.mime_types && (conf.filters.mime_types.regexp = function (mime_types) {// 验证 mime_types 格式
                            var t = [];
                            return o.each(mime_types, function (mime_types) {
                                o.each(mime_types.extensions.split(/,/), function (e) {
                                    /^\s*\*\s*$/.test(e) ?
                                        t.push("\\.*") :
                                        t.push("\\." + e.replace(new RegExp("[" + "/^$.*+?|()[]{}\\".replace(/./g, "\\$&") + "]", "g"), "\\$&"))
                                })
                            }), new RegExp("(" + t.join("|") + ")$", "i")
                        }(conf.filters.mime_types));
                        break;
//                    case"max_file_size":
//                        conf.max_file_size = conf.filters.max_file_size = val;
//                        break;
//                    case"chunk_size":
//                        if (val = o.parseSize(val))conf[prop] = val, conf.send_file_name = !0;
//                        break;
//                    case"multipart":
//                        conf[prop] = val, val || (conf.send_file_name = !0);
//                        break;
//                    case"unique_names":
//                        conf[prop] = val, val && (conf.send_file_name = !0);
//                        break;
//                    case"resize":
//                        extend ? o.extend(conf.resize, val, {enabled: !0}) : conf.resize = val;
//                        break;
//                    case"prevent_duplicates":
//                        conf.prevent_duplicates = conf.filters.prevent_duplicates = !!val;
//                        break;
                    case"browse_button":
//                    case"drop_element":
                        val = o.get(val);
...
//                    case"silverlight_xap_url":
                        conf[prop] = val, extend || (u = !0);
                        break;
                    default:
                        conf[prop] = val
                }
                extend || _this.trigger("OptionChanged", prop, val, r)
            }

            var _this = this, u = !1;
            typeof _options == "object" ?
                o.each(_options, function (prop, val) {
                    f(val, prop, extend)
                }) : f(_options, n, extend),
                extend ?
                    (conf.required_features = s(o.extend({}, conf)), l = s(o.extend({}, conf, {required_features: !0}))) :
                    // 销毁 o.Uploader
                    u && (_this.trigger("Destroy"), x.call(_this, conf, function (e) {
                    e ?
                        (_this.runtime = t.Runtime.getInfo(w()).type, _this.trigger("Init", {runtime: _this.runtime}), _this.trigger("PostInit")) :
                        _this.trigger("Error", {code: o.INIT_ERROR, message: "Init error."})
                }))
        }
...
//            }
        ...
        // UploadFile
        function k(uploader, file) {
            function h() {// r: setTimeout
                u-- > 0 ? r(p, 1e3) : (file.loaded = f, uploader.trigger("Error", {code: o.HTTP_ERROR, message: "HTTP Error.", file: file, response: xhr.responseText, status: xhr.status, responseHeaders: xhr.getAllResponseHeaders()}))
            }

            function p() {
                var d, v, g = {}, y;
                if (file.status !== o.UPLOADING || uploader.state === o.STOPPED)return;
//                uploader.settings.send_file_name && (g.name = file.target_name || file.name), del test 此行
                /*s && conf.chunks && c.size > s ? (y = Math.min(s, c.size - f), d = c.slice(f, f + y)) :*/
                (y = c.size, d = c),
                /*s && conf.chunks && (uploader.settings.send_chunk_number ? (g.chunk = Math.ceil(f / s), g.chunks = Math.ceil(c.size / s)) : (g.offset = f, g.total = c.size)),*/
                xhr = new _moxieMethods.XMLHttpRequest,
                /*xhr.upload && (xhr.upload.onprogress = function (t) { del test
                    file.loaded = Math.min(file.size, f + t.loaded), uploader.trigger("UploadProgress", file)
                }),*/
                /*xhr.onload = function () { del test
                    if (xhr.status >= 400) {// 报错
                        h();
                        return
                    }
                    u = uploader.settings.max_retries,
                    y < c.size ?
                        (
                            d.destroy(),
                            f += y,
                            file.loaded = Math.min(f, c.size),
                            uploader.trigger("ChunkUploaded", file, {offset: file.loaded, total: c.size, response: xhr.responseText, status: xhr.status, responseHeaders: xhr.getAllResponseHeaders()}),
                            t.Env.browser === "Android Browser" && uploader.trigger("UploadProgress", file)
                        ) :
                        file.loaded = file.size,
                    d = v = null,
                    !f || f >= c.size ?
                        (
                            file.size != file.origSize && (c.destroy(), c = null),
                            uploader.trigger("UploadProgress", file),
                            file.status = o.DONE,
                            uploader.trigger("FileUploaded", file, {response: xhr.responseText, status: xhr.status, responseHeaders: xhr.getAllResponseHeaders()})
                        ) :
                        r(p, 1)
                },
                ...
                xhr.onloadend = function () {
                    this.destroy(), xhr = null
                },
                uploader.settings.multipart && a.multipart ?
                    (*/
                        // 初始化 xhr
                        xhr.open("post", i, !0),
                        /*o.each(uploader.settings.headers, function (e, t) { del test
                            xhr.setRequestHeader(t, e)
                        }),*/
                        v = new _moxieMethods.FormData,
                        /*o.each(o.extend(g, uploader.settings.multipart_params), function (e, t) { del test
                            v.append(t, e)
                        }),*/
                        v.append(uploader.settings.file_data_name, d),
                        xhr.send(v, {
/*                            runtime_order: uploader.settings.runtimes, del test
                    ...
                    (
                        i = o.buildUrl(uploader.settings.url, o.extend(g, uploader.settings.multipart_params)),
                        xhr.open("post", i, !0),
                        xhr.setRequestHeader("Content-Type", "application/octet-stream"),
                        o.each(uploader.settings.headers, function (e, t) {
                            xhr.setRequestHeader(t, e)
                        }),
                        xhr.send(d, {runtime_order: uploader.settings.runtimes, required_caps: uploader.settings.required_features, preferred_caps: l, swf_url: uploader.settings.flash_swf_url, xap_url: uploader.settings.silverlight_xap_url})
                    )*/
            }

//            var i = uploader.settings.url, s = uploader.settings.chunk_size, u = uploader.settings.max_retries, a = uploader.features, f = 0, c;
            var i = uploader.settings.url, s = 0, u = 0, a = uploader.features, f = 0, c;
//            file.loaded && (f = file.loaded = s ? s * Math.floor(file.loaded / s) : 0),
            c = file.getSource(),
//            uploader.settings.resize.enabled && E(c, "send_binary_string") && !!~_moxieMethods.inArray(c.type, ["image/jpeg", "image/png"]) ? T.call(this, c, uploader.settings.resize, function (e) {
//                c = e, file.size = e.size, p()
//            }) : p()
            p()
        }
        // UploadProgress
...
//                    e.files[t].status == o.UPLOADING && (e.files[t].status = o.QUEUED, b())
        ...
        function _(e, t) {
            t.code === o.INIT_ERROR ?
                e.destroy() :
                t.file && (t.file.status = o.FAILED, y(t.file), e.state == o.STARTED && (e.trigger("CancelUpload"), r(
                function () {
                    g.call(e)
                }, 1)));
        }
        ...
        function D(e) {
            e.stop(), o.each(f, function (e) {
                ...
                e.destroy()
            }), h = []), l = {}, v = !1, p = xhr = null, d.reset()
        }

        var u = o.guid()// _moxieMethods.guid() - 获取唯一键值
            ,conf = {// 默认配置
                runtimes: _moxieMethods.Runtime.order// 上传方式："html5,flash,silverlight,html4"
                ,max_retries: 0// ------ 重试次数，0 不重试
                ,chunk_size: 0// ------
                ,multipart: !0// ------
                ,multi_selection: !0// 是否允许多选，默认允许
                ,file_data_name: "file"// ------
                ,flash_swf_url: "js/Moxie.swf"// ie9 需使用 flash 上传
        ...
        N.call(this, options, null, !0)
            ...
            ,init: function () {
                var e = this;
                typeof conf.preinit == "function" ? conf.preinit(e) : o.each(conf.preinit, function (t, n) {
                    e.bind(n, t)
                }), S.call(this);
                if (!conf.browse_button || !conf.url) {// 必须定义触发元素 和 上传 url
                    this.trigger("Error", {code: o.INIT_ERROR, message: "Init error."});
                    return
                }
                x.call(this, conf, function (n) {
                    typeof conf.init == "function" ? conf.init(e) : o.each(conf.init, function (t, n) {
                        e.bind(n, t)
                    }), n ? (e.runtime = _moxieMethods.Runtime.getInfo(w()).type, e.trigger("Init", {runtime: e.runtime}), e.trigger("PostInit")) : e.trigger("Error", {code: o.INIT_ERROR, message: "Init error."})
                })
            }
            ...
            ,addFile: function (e, n) {
                function c(e, n) {
                    var r = [];
                    _moxieMethods.each(s.settings.filters, function (t, n) {
                        i[n] && r.push(function (r) {
                            i[n].call(s, t, e, function (e) {
                                r(!e)
                            })
                        })
                    }), _moxieMethods.inSeries(r, n)
                }

                function h(e) {
                    var i = _typeOf(e);
                    if (e instanceof _moxieMethods.File) {
                        if (!e.ruid && !e.isDetached()) {
                            if (!l)return!1;
                            e.ruid = l, e.connectRuntime(l)
                        }
                        h(new o.File(e))
                    } else e instanceof _moxieMethods.Blob ? (h(e.getSource()), e.destroy()) : e instanceof o.File ? (n && (e.name = n), u.push(function (t) {
                        c(e, function (n) {
                            n || (f.push(e), a.push(e), s.trigger("FileFiltered", e)), r(t, 1)
                        })
                    })) : _moxieMethods.inArray(i, ["file", "blob"]) !== -1 ? h(new _moxieMethods.File(null, e)) : i === "node" && _typeOf(e.files) === "filelist" ? _moxieMethods.each(e.files, h) : i === "array" && (n = null, _moxieMethods.each(e, h))
                }
                ...
                l = w(),
                h(e),
                u.length && _moxieMethods.inSeries(u, function () {
            ...
            ,splice: function (e, t) {
                var r = f.splice(e === _undef ? 0 : e, t === _undef ? f.length : t), i = !1;
            ...
            ,destroy: function () {
                this.trigger("Destroy"), conf = d = null, this.unbindAll()
            }
        })
    },
    o.Uploader.prototype = _moxieMethods.EventTarget.instance,// 返回 o.Uploader 对象类型原型的引用
    o.File = function () {
        function n(n) {
            o.extend(this, {id: o.guid(), name: n.name || n.fileName, type: n.type || "", size: n.size || n.fileSize, origSize: n.size || n.fileSize, loaded: 0, percent: 0, status: o.QUEUED, lastModifiedDate: n.lastModifiedDate || (new Date).toLocaleString(), getNative: function () {
                ...
                return _moxieMethods.inArray(_typeOf(e), ["blob", "file"]) !== -1 ? e : null
            }, getSource: function () {
